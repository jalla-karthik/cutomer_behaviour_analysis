...
--compare the average purchase amounts between standards and express shipping
SELECT 
    shipping_type,
...
--Do subscribed customers spend more?compare average spend and total revenue between sub and non -Subscribers
SELECT 
    subscription_status,
